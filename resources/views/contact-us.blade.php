            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="contact-card bg-white p-8 rounded-xl border border-gray-100 text-center">
                    ...
                    <a href="mailto:info@example.com"
                        class="text-blue-600 hover:text-blue-800 font-medium">info@example.com</a>
                </div>
                ...
                <div class="contact-card bg-white p-8 rounded-xl border border-gray-100 text-center">
                    ...
                    <a href="tel:+966123456789" class="text-blue-600 hover:text-blue-800 font-medium">+966 12 345
                        6789</a>
                </div>
